"""
Fichier permettant de générer des graphiques à partir du nom des epochs sauvegardé
"""
...
# On boucle sur les nom des modèles
for data, nn_size in models:
    ...
    for fn in data:
        ...
        # On extrait pour chaque epoch les valeurs intéréssantes
    ...
    # Et on stocke les valeur dans ce dictionnaire
...
# Premier graphique sur jeu d'entrainement
...
# Deuxième graphique sur jeu de validation
fig, axs = plt.subplots(1, 2)
